    ...
    <scroll-view scroll-y="true" class="page-content">
      ...
      <view class="mall-bar flex-box">
        <view class="flex-item">
          <image src="../../static/image/account/a_m1.png" mode="aspectFit" class="icon"></image>
          消息
        </view>
        <view class="flex-item">
          <image src="../../static/image/account/a_m2.png" mode="aspectFit" class="icon"></image>
          商城
          <view class="txt">
            29元包邮
          </view>
        ...
        <view class="flex-item">
          <image src="../../static/image/account/a_m3.png" mode="aspectFit" class="icon"></image>
          演出
          <view class="txt">
            天鹅湖
          </view>
        ...
        <view class="flex-item">
          <image src="../../static/image/account/a_m4.png" mode="aspectFit" class="icon"></image>
          个性换肤
        </view>
      </view>
      <!-- uni列表 -->
